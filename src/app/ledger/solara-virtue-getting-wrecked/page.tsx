...
export default function SolaraThesis() {
  return (
      ...
      <main className="max-w-4xl space-y-8">
        ...
        <header className="space-y-6 pb-8 border-b border-purple-500">
          ...
          <div className="bg-purple-500 text-black p-4 text-sm">
            ...
            Indian pharmaceutical company specializing in Active Pharmaceutical Ingredients (APIs) and Contract Research & Manufacturing Services (CRAMS). Founded in 2017, headquartered in Hyderabad. Previously heavily dependent on Ibuprofen manufacturing, now transitioning to specialty chemicals and higher-value chemistries. Market cap: ~₹2,500 crores.
          </div>
        </header>
        ...
        <article className="space-y-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold pt-8">
            Recommendation: An Asymmetric Bet on Proven Architects
          </h2>
          ...
          <p>
            The combination of a clean balance sheet, a clear strategic pivot towards higher-margin chemistries, a massive latent asset in Vizag, and a clear value-unlocking catalyst via the CRAMS demerger provides multiple pathways to victory. We are buying a future specialty chemical company at a discounted commodity chemical price. Of course, the ghosts of the old machine could still drag it to hell.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Solara: The Virtue of Getting Wrecked",
            "author": {
              "@type": "Person",
              "name": "Abhay Jain",
              "url": "https://www.abhayadityajain.com"
            },
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://www.abhayadityajain.com/ledger/solara-virtue-getting-wrecked"
            },
            "publisher": {
              "@type": "Person",
              "name": "Abhay Jain"
