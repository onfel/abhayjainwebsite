...
export const metadata: Metadata = {
  ...
  description: "Investment insights and financial theses by Abhay Jain. Deep analysis on companies like Laurus Labs and market opportunities in the AI-native economy.",
  keywords: "Abhay Jain investment, financial thesis, Laurus Labs analysis, equity research, investment insights",
  openGraph: {
    title: "The Ledger - Financial Theses by Abhay Jain",
    description: "Investment insights and financial theses by Abhay Jain. Deep analysis on companies like Laurus Labs and market opportunities.",
    type: "website",
  },
};
        ...
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <Link href="/ledger" className="text-gray-600 hover:text-gray-900 transition-colors font-semibold">
                Ledger
              </Link>
            </div>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-6 pt-32 pb-20">
        ...
        <article className="prose prose-lg max-w-none">
          ...
          <div className="text-gray-700 leading-relaxed space-y-6">
            ...
            <p>
              <strong>And yet… what a caterpillar calls the end, the rest of the world calls a butterfly.</strong>
            </p>
            ...
            <p>
              <strong>Frankly, they are building a machine the market is structurally incapable of pricing.</strong>
            </p>
